...
void HealthBar::on_render()
{
    ...
    // Health Bar Fill
    DrawTexturePro(HealthBar::texture_health_atlas, {0, 120, health_bar_width * this->health.get_health(true), 120}, {0, 0, health_bar_width * this->health.get_health(true) * this->scale + this->size.x, 120  * this->scale + this->size.y}, { -this->position.x, -this->position.y }, 0, WHITE);
}